...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        top.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mStoryIndex == 1 || mStoryIndex==2) {
                    question.setText(R.string.T3_Story);
                    top.setText(R.string.T3_Ans1);
                    bottom.setText(R.string.T3_Ans2);
                    mStoryIndex=3;
                }
                else{
                    question.setText(R.string.T6_End);
                }
            }
        });
        ...
        bottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mStoryIndex==1){
                question.setText(R.string.T2_Story);
                top.setText(R.string.T2_Ans1 );
                bottom.setText(R.string.T2_Ans2);
                mStoryIndex=2;
                }
                else if(mStoryIndex==2){
                    question.setText(R.string.T4_End);
                    top.setVisibility(View.GONE);
                    bottom.setVisibility(View.GONE);
                }
                else{
                    question.setText(R.string.T5_End);
                    top.setVisibility(View.GONE);
                    bottom.setVisibility(View.GONE);
                }
            }
